...
대본 작성 규칙:
1. 분량: 1200~1800자 (읽으메 5~8분 분량)
2. 톤: 뉴스 앵커처럼 싨뢰감 있되, 감탄과 자부심을 자연스럽게 유도
...
반드시 JSON 형식으로 응답:
{
  ...
  "tags": ["태그1", "태그2", ...],
  "description": "영상 설명 (200자, 해시태그 폨함)"
}"""
